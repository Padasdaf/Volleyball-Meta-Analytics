...
fig = reliability_figure("mlv")
plt.show()
plt.close(fig)

fig = independence_figure("mlv")
plt.show()
plt.close(fig)
```
...
fig = reliability_figure("lovb")
plt.show()
plt.close(fig)

fig = independence_figure("lovb")
plt.show()
plt.close(fig)
```
...
fig = reliability_figure("au")
plt.show()
plt.close(fig)

fig = independence_figure("au")
plt.show()
plt.close(fig)
```
