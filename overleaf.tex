...
The meta-analytic framework was developed to address a related problem arising from the growing number of player-performance metrics in sports: determining which statistics provide reliable and distinct information \citep{franks_meta-analytics_2016}. Rather than proposing another performance metric, the framework evaluates statistical properties of existing metrics. Its original application considered more than 70 metrics from the National Basketball Association (NBA) and 40 metrics from the National Hockey League (NHL), demonstrating that metrics with substantially different constructions and distributions can be assessed within a common framework.
...
These applications demonstrate that the usefulness of a sports metric cannot be inferred solely from its familiarity, complexity, or interpretation. Metrics that appear different may contain highly redundant information, while observed differences between players may in some cases be strongly influenced by sampling variability. Although volleyball research has produced an increasingly diverse set of traditional and advanced performance measures, comparable meta-analytic evaluation has not been conducted in the sport. The present study extends this line of work by systematically examining the statistical properties of individual-player volleyball metrics.
